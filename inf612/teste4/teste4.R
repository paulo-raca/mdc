...
cepagry_jan_1 <- cepagri_date_range(1, 1)
...
# O arquivo não possui dados entre 13/01/2018-09:30 e 14/01/2018-10:30
p <- ggplot(cepagri_date_range(13, 14), aes(x = Horario, y = Sensacao))
p <- p + geom_line()
p
